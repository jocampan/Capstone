...
if($name !=''||$description !=''){
//Insert Query of SQL
$query = mysql_query("insert into salads(name, description, price) values ('$name', '$description', '$price')");
...
<div class="form_div">
<div class="title">
<H1>&nbsp;John John's Dogs</H1><H2>"Salad" Webpage Maintenance</H2>
<p> Please enter a new Salad update below</p>
</div>
<form action="saladsupload.php" method="post">
