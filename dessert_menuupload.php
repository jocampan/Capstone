...
//Insert Query of SQL
$query = mysql_query("insert into desert_menu(name, description, price) values ('$name', '$description', '$price')");
...
<div class="form_div">
<div class="title">
<H1>&nbsp;John John's Dogs</H1><H2>"Deserts" Webpage Maintenance</H2>
<p> Please enter a new Desert update below</p>
</div>
<form action="dessert_menuupload.php" method="post">
